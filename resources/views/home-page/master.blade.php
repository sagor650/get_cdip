...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- font-awesome icons -->
    <link rel="stylesheet" href="home-page/css/font.css" type="text/css"/>
    <link href="home-page/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="home-page/css/morris.css" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="home-page/css/monthly.css">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="home-page/js/jquery2.0.3.min.js"></script>
    <script src="home-page/js/raphael-min.js"></script>
    <script src="home-page/js/morris.js"></script>
</head>
<body>
...
<!--logo start-->
<div class="brand">
    <img src="home-page/images/cdip.png">
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="home-page/images/2.png"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="home-page/images/2.png">
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="home-page/js/flot-chart/excanvas.min.js"></script><![endif]-->
...
<!-- calendar -->
	<script type="text/javascript" src="home-page/js/monthly.js"></script>
