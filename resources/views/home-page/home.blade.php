...
@section('body')
    ...
    <script src="home-page/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="home-page/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="home-page/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="home-page/js/plugins/plugins.js"></script>
    <!-- Active js -->
    <script src="home-page/js/active.js"></script>
