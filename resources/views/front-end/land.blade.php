...
<head>
    ...
    <!--//meta tags ends here-->
    <!--booststrap-->
    <link href="front-end/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
    <!--//booststrap end-->
    <!-- font-awesome icons -->
    <link href="front-end/css/fontawesome-all.min.css" rel="stylesheet" type="text/css" media="all">
    <!-- //font-awesome icons -->
    <link href="front-end/css/blast.min.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="front-end/css/style10.css" />
    <!--stylesheets-->
    <link href="front-end/css/style.css" rel='stylesheet' type='text/css' media="all">
    <!--//stylesheets-->
...
<div class="header-outs" id="header">
    <div class="header-w3layouts">
        <div class="container">
            <div class="row headder-contact">
                <div class="col-lg-6 col-md-7 col-sm-9 info-contact-agile">
                    <ul>
                        <li>
                            ...
                            <p>01788670149 / 01675315160
                            </p>
                        </li>
                        <li>
                            <span class="fas fa-envelope"></span>
                            <p><a href="mailto:info@example.com">cdip@uiu.ac.bd</a></p>
                        </li>
                        <li>
                        </li>
                    </ul>
                ...
                <div class="col-lg-6 col-md-5 col-sm-3 icons px-0">
                    <ul>
                        <li><a href="https://www.facebook.com/CDIP.info/"><span class="fab fa-facebook-f"></span></a></li>
                        <li><a href="#"><span class="fas fa-envelope"></span></a></li>
                        <li><a href="#"><span class="fas fa-rss"></span></a></li>
                        <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                        <li><a href="https://www.linkedin.com/company/center-for-development-of-it-professionals-cdip-uiu"><span class="fab fa-linkedin"></span></a></li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="hedder-up">
                <h1 ><a href="" class="navbar-brand" data-blast="color">GET CDIP</a></h1>
            </div>
            ...
            <div class="headdser-nav-color" data-blast="bgColor">
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a href="#blog" class="nav-link scroll">Review</a>
                        </li>
                        <li class="nav-item">
                            <a href="#team" class="nav-link scroll">Management</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container-fluid ">
        <div class="main row ">
            ...
            <div class="col-lg-4 view view-tenth">
                <img src="front-end/images/ab1.jpg" alt="" class="img-fluid">
                <div class="mask">
            ...
            <div class="col-lg-4 view view-tenth">
                <img src="front-end/images/ab2.jpg" alt="" class="img-fluid">
                <div class="mask">
            ...
            <div class="col-lg-4 view view-tenth">
                <img src="front-end/images/ab3.jpg" alt="" class="img-fluid">
                <div class="mask">
            ...
            <div class="resp-tabs-container">
                <div class="tab1" >
                    <div class="row mt-lg-4 mt-3">
                        ...
                        <div class="col-md-5 about-txt-img">
                            <img src="front-end/images/ab1.jpg" class="img-thumbnail" alt="">
                        </div>
                    </div>
                </div>
                <div class="tab2">
                    <div class="row mt-lg-4 mt-3">
                        <div class="col-md-5 about-txt-img">
                            <img src="front-end/images/ab3.jpg" class="img-thumbnail" alt="">
                        </div>
                        <div class="col-md-7 latest-list">
                            <div class="about-jewel-agile-left">
                ...
                <div class="tab3">
                    <div class="row mt-lg-4 mt-3">
                        ...
                        <div class="col-md-5 about-txt-img">
                            <img src="front-end/images/ab2.jpg" class="img-thumbnail" alt="">
                        </div>
                    </div>
                </div>
                <div class="tab4">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">PHP, OOP & LARAVEL (WITH FREELANCING)</h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">C#, ASP .NET & MVC</h4>
                        <p>delectus reiciendis maiores alias consequatur aut.maiores alias</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">WEB DESIGN & DEVELOPMENT (WITH FREELANCING)</h4>
                        <p>delectus reiciendis maiores alias consequatur aut.maiores alias</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center mt-md-4 mt-sm-3 mt-3">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">WORDPRESS THEME & PLUGIN DEVELOPMENT (WITH FREELANCING)</h4>
                        <p>delectus reiciendis maiores alias consequatur aut.maiores alias</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center mt-md-4 mt-sm-3 mt-3">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">GRAPHICS DESIGN (WITH FREELANCING)</h4>
                        <p>delectus reiciendis maiores alias consequatur aut.maiores alias</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center mt-md-4 mt-sm-3 mt-3">
                <div class="white-shadow">
                    ...
                    <div class="ser-inner-info">
                        <h4 class="my-3">INTRODUCTION TO PYTHON AND BIG DATA ANALYSIS</h4>
                        <p>delectus reiciendis maiores alias consequatur aut.maiores alias</p>
                    </div>
                </div>
            </div>
...
<section class="blog py-lg-4 py-md-3 py-sm-3 py-3" id="blog">
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Student's Review </h3>
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 blog-grid-flex">
                <div class="clients-color">
                    <img src="front-end/images/ab3.jpg" class="img-fluid" alt="">
                    <div class="blog-txt-info">
                        ...
                        <p>Lorems ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et</p>
                        <div class="outs_more-buttn" >
                            <a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="bgColor">More</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6  blog-grid-flex">
                <div class="clients-color">
                    <img src="front-end/images/ab1.jpg" class="img-fluid" alt="">
                    <div class="blog-txt-info">
                        <h4 class="mt-2"><a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="color">Quisque a rhoncus </a></h4>
                        <div class="news-date my-3">
                            <ul>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 blog-grid-flex">
                <div class="clients-color">
                    <img src="front-end/images/ab2.jpg" class="img-fluid" alt="">
                    <div class="blog-txt-info">
                        <h4 class="mt-2"><a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="color">Quisque a rhoncus </a></h4>
                        <div class="news-date my-3">
                            <ul>
...
<section class="stats py-lg-4 py-md-3 py-sm-3 py-3" id="stats">
    <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">status </h3>
            ...
            <div class="row stats-info">
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 stats-grid-1">
                    <div class="stats-grid" data-blast="bgColor">
                        ...
                        <div class="stat-info">
                            <h5 class="pt-2">Total Students</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6 stats-grid-4">
                    <div class=" stats-grid" data-blast="bgColor">
                        ...
                        <div class="stat-info">
                            <h5 class="pt-2">Total Projects </h5>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="team py-lg-4 py-md-3 py-sm-3 py-3" id="team">
    <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Management </h3>
        <div class="row ">
            <div class="col-lg-3 col-md-6 col-sm-6 profile">
                <div class="team-shadow">
                    <div class="img-box">
                        <img src="front-end/images/t1.jpg" alt="">
                    ...
                    <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                        <h4 class="text-white mb-2">Suman Ahmmed</h4>
                        <span class="wls-client-title text-black">Director- CDIP, Asst. Professor, CSE, UIU</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 profile">
                <div class="team-shadow">
                    <div class="img-box">
                        <img src="front-end/images/t2.jpg" alt="">
                        <div class="list-social-icons">
                            <ul>
                                <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                <li><a href="#"><span class="fas fa-envelope"></span></a></li>
                    ...
                    <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                        <h4 class="text-white mb-2">Professor Dr. Chowdhury Mofizur Rahman</h4>
                        <span class="wls-client-title text-black">Chief Advisor - CDIP, Vice-Chancellor, UIU</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 profile">
                <div class="team-shadow">
                    <div class="img-box">
                        <div class="team-list-img">
                            <img src="front-end/images/t3.jpg" alt="">
                        </div>
                        <div class="list-social-icons">
                            <ul>
                                <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                    ...
                    <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                        <h4 class="text-white mb-2">Dr. Salekul Islam</h4>
                        <span class="wls-client-title text-black">Advisor - CDIP, Associate Professor & Head of the Dept. of CSE, UIU</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 profile">
                <div class="team-shadow">
                    <div class="img-box">
                        <div class="team-list-img">
                            <img src="front-end/images/t4.jpg" alt="">
                        </div>
                        <div class="list-social-icons">
                            <ul>
                                <li><a href="#"><span class="fab fa-facebook-f" ></span></a></li>
                    ...
                    <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                        <h4 class="text-white mb-2">S.M. Jabid Hasan</h4>
                        <span class="wls-client-title text-black">Coordinator CDIP, Sr. Web Developer at United International University.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-5 address-grid">
                <div class="addres-office-hour text-center" >
                    <ul>
                        ...
                        <li>
                            <p>UIU Permanent Campus,United City, Madani Avenue,<br> Badda Dhaka-1212, Bangladesh.</p>
                        </li>
                    </ul>
                    <ul>
            ...
            <div class="dance-agile-info col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="footer-grid row mb-3">
                    <div class="col-lg-5 col-md-6 col-sm-6 col-5">
                        <img src="front-end/images/bb1.jpg" alt=" " class="img-fluid">
                    </div>
                ...
                <div class="footer-grid row mb-3">
                    <div class="col-lg-5 col-md-6 col-sm-6 col-5">
                        <img src="front-end/images/bb2.jpg" alt=" " class="img-fluid">
                    </div>
                    <div class="col-lg-7 col-md-6 col-sm-6 col-7 bottom-para px-0">
                        <h6><a href="#" data-toggle="modal" data-target="#exampleModalLive">ultricies nec,pellen eu,pretium quis,</a></h6>
                        <div class="news-bloger">
                ...
                <div class="footer-grid row">
                    <div class="col-lg-5 col-md-6 col-sm-6 col-5">
                        <img src="front-end/images/bb3.jpg" alt=" " class="img-fluid">
                    </div>
                    <div class="col-lg-7 col-md-6 col-sm-6 col-7 bottom-para px-0">
                        <h6><a href="#" data-toggle="modal" data-target="#exampleModalLive">ultricies nec,pellen eu,pretium quis,</a></h6>
                        <div class="news-bloger">
                ...
                <div class="footer-post d-flex mb-2">
                    <div class="agileinfo_footer_grid1 mr-2">
                        <a href="#blog" class=" scroll">
                            <img src="front-end/images/f1.jpg" alt=" " class="img-fluid">
                        </a>
                    </div>
                    <div class="agileinfo_footer_grid1 mr-2">
                        <a href="#blog" class="scroll">
                            <img src="front-end/images/f2.jpg" alt=" " class="img-fluid">
                        </a>
                    </div>
                    <div class="agileinfo_footer_grid1">
                        <a href="#blog" class="scroll">
                            <img src="front-end/images/f3.jpg" alt=" " class="img-fluid">
                        </a>
                    </div>
                </div>
                <div class="footer-post d-flex mb-2">
        ...
        <div class="buttom-nav ">
            <nav class="border-line py-2">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="#blog" class="nav-link scroll">Contact</a>
                    </li>
                    <li class="nav-item">
...
<footer class="py-3">
    <div class="container">
        <div class="copy-agile-right text-center">
            ...
            <p>
                © 2019 GET CDIP. All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">W3Layouts</a>
            </p>
        </div>
    </div>
</footer>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLiveLabel" data-blast="color">GET CDIP</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <img src="front-end/images/b2.jpg" alt="" class="img-fluid">
...
<!--//model-->
<!--js working-->
<script src='front-end/js/jquery-2.2.3.min.js'></script>
<!--//js working-->
<!--blast colors change-->
<script src="front-end/js/blast.min.js"></script>
<!--//blast colors change-->
...
<script src="front-end/js/jquery.countup.js"></script>
<script>
    $('.counter').countUp();
</script>
<!-- //OnScroll-Number-Increase-JavaScript -->
<!-- start-smoth-scrolling -->
<script src="front-end/js/move-top.js"></script>
<script src="front-end/js/easing.js"></script>
<script>
